...
class CreateForeignKeys extends Migration {
	...
	public function up()
	{
		...
		Schema::table('applicant_experience', function(Blueprint $table) {
			$table->foreign('applicant_id')->references('id')->on('applicant')
						->onDelete('restrict')
						->onUpdate('restrict');
		});
	...
	public function down()
	{
		...
		Schema::table('applicant_education', function(Blueprint $table) {
			$table->dropForeign('applicant_education_applicant_id_foreign');
		});
		Schema::table('applicant_education', function(Blueprint $table) {
			$table->dropForeign('applicant_education_education_id_foreign');
		});
		Schema::table('applicant_experience', function(Blueprint $table) {
			$table->dropForeign('applicant_experience_applicant_id_foreign');
		});
		Schema::table('applicant_experience', function(Blueprint $table) {
			$table->dropForeign('applicant_experience_experience_id_foreign');
		});
		Schema::table('applicant_jobrole', function(Blueprint $table) {
